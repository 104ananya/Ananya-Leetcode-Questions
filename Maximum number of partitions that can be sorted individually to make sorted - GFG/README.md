...
<pre style="position: relative;"><span style="font-size:18px"><strong>â€‹Input :</strong> arr[ ] = {2, 1, 0, 3}
...
<pre style="position: relative;"><span style="font-size:18px"><strong>Input :</strong> arr[ ] = {2, 1, 0, 3, 4, 5} <strong>
Output :</strong>  4 </span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
